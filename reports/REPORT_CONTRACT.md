...
- Merchant presentation correction, 5 September: use the supplied CleanShot 1.49.40 AM screenshot unchanged at 2680 × 1646 in one full-width, full-size-linked figure. Replace the earlier low-resolution status/feed crops. Highlight its 531 combined store-and-product clicks for August 7–September 3, 110 currently approved listings and Great store quality. Clearly distinguish its 28-day reporting window from calendar August and its current approval snapshot. Do not characterize the overall channel using only the narrower August product-listing traffic figure. Do not claim sales, orders, or a causal migration uplift from this screenshot.
